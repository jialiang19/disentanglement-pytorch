...
class PROAE2(BaseDisentangler):
    def __init__(self, args):
       ...
       #new_encoder.new_task()  
        ...
        new_decoder = decoder(self.z_dim, self.num_channels, self.image_size)
        
       #new_decoder.new_task() 
       #new_decoder.new_task() 

        self.model = PROAE2Model(new_encoder, new_decoder).to(self.device)
    ...
    def train(self):
        while not self.training_complete():
            ...
            for x_true1, _ in self.data_loader:
                ...
                self.model.encoder.fc.weight.grad[:-1,:] = 0 
                self.model.encoder.fc.bias.grad[:-1] = 0 
                self.model.decoder.first_conv.weight.grad[:,:-1,:,:] = 0 
                self.optim_G.step()
...
#                if self.iter%100==0: 
#                    print(self.model.decoder.first_conv.weight.grad.shape) 
#                    print(self.model.decoder.first_conv.bias.grad.shape) 
#                    print(self.model.encoder.fc) 
#                    print(self.num_batches) 
#                    print(self.args.inc_every_n_epoch)
#                    print(int(self.num_batches * self.args.inc_every_n_epoch)) 
